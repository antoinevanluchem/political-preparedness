...
class RepresentativeListAdapter: ListAdapter<Representative, ViewHolder>(RepresentativeDiffCallback()){
...
class ViewHolder(val binding: ViewholderRepresentativeBinding): RecyclerView.ViewHolder(binding.root) {
